...
void MainGame::init() {
    ...
    m_spriteFont = std::make_unique<GTEngine::SpriteFont>("Fonts/chintzy.ttf", 40);
...
struct BallSpawn {
    BallSpawn(const GTEngine::ColorRGBA8& colr,
...
void MainGame::initBalls() {
    ...
    ADD_BALL(1.0f, GTEngine::ColorRGBA8(255, 255, 255, 255),
             2.0f, 1.0f, 0.1f, 7.0f, totalProbability);
    ADD_BALL(1.0f, GTEngine::ColorRGBA8(1, 254, 145, 255),
             2.0f, 2.0f, 0.1f, 3.0f, totalProbability);
    ADD_BALL(1.0f, GTEngine::ColorRGBA8(177, 0, 254, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability)
    ADD_BALL(1.0f, GTEngine::ColorRGBA8(254, 0, 0, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
    ADD_BALL(1.0f, GTEngine::ColorRGBA8(0, 255, 255, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
    ADD_BALL(1.0f, GTEngine::ColorRGBA8(255, 255, 0, 255),
             3.0f, 4.0f, 0.0f, 0.0f, totalProbability);
    // Make a bunch of random ball types
    for (int i = 0; i < 10000; i++) {
        ADD_BALL(1.0f, GTEngine::ColorRGBA8(r2(randomEngine), r2(randomEngine), r2(randomEngine), 255),
    ...
    for (int i = 0; i < NUM_BALLS; i++) {
        ...
        m_balls.emplace_back(ballToSpawn->radius, ballToSpawn->mass, pos, direction * ballToSpawn->randSpeed(randomEngine),
			GTEngine::ResourceManager::getTexture("Textures/circle.png").id,
                             ballToSpawn->color);
...
void MainGame::drawHud() {
    const GTEngine::ColorRGBA8 fontColor(255, 0, 0, 255);
